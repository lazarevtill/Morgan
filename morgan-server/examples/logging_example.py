...
def example_basic_logging():
    ...
    # Configure logging
    configure_logging(log_level="INFO", log_format="json", enable_console=True)
...
def example_context_fields():
    ...
    context = setup_request_logging(
        request_id="req_12345", user_id="user_67890", conversation_id="conv_abcde"
    )
...
def example_exception_logging():
    ...
    # Configure logging
    configure_logging(log_level="ERROR", log_format="json", enable_console=True)
...
def example_text_format():
    ...
    configure_logging(log_level="INFO", log_format="text", enable_console=True)
    ...
    # Log with context
    logger.info(
        "Processing request", extra={"request_id": "req_12345", "user_id": "user_67890"}
    )
...
def example_log_levels():
    ...
    configure_logging(log_level="WARNING", log_format="text", enable_console=True)
