...
class TestConversationCreation:
    ...
    def test_get_or_create_conversation_creates_new(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            conversation = manager.get_or_create_conversation("conv123", "user123")
...
class TestMessageManagement:
    ...
    def test_add_message_to_conversation(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            message = manager.add_message("conv123", MessageRole.USER, "Hello, Morgan!")
    ...
    def test_add_message_with_metadata(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            message = manager.add_message(
                "conv123", MessageRole.ASSISTANT, "I'm here to help!", metadata=metadata
            )
    ...
    def test_message_has_timestamp(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            before = datetime.now()
            message = manager.add_message("conv123", MessageRole.USER, "Hello")
            after = datetime.now()
    ...
    def test_get_messages_by_role(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assistant_messages = conversation.get_messages(role=MessageRole.ASSISTANT)

            assert len(user_messages) == 2
            assert len(assistant_messages) == 2
            assert all(m.role == MessageRole.USER for m in user_messages)
            assert all(m.role == MessageRole.ASSISTANT for m in assistant_messages)
...
class TestContextRetrieval:
    ...
    def test_get_conversation_context(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            manager.create_conversation("conv123", "user123")
            for i in range(15):
                manager.add_message("conv123", MessageRole.USER, f"Message {i}")
...
class TestMemorySearch:
    ...
    def test_search_conversations_basic(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            manager.add_message("conv1", MessageRole.ASSISTANT, "AI is fascinating")
    ...
    def test_search_conversations_with_limit(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            manager.create_conversation("conv1", "user123")
            for i in range(10):
                manager.add_message("conv1", MessageRole.USER, f"Message about AI {i}")
    ...
    def test_search_conversations_relevance_scoring(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            manager.add_message("conv1", MessageRole.USER, "Tell me about AI")
            manager.add_message("conv1", MessageRole.USER, "AI AI AI AI")
...
class TestMemoryPersistence:
    ...
    def test_conversation_serialization_deserialization(self):
        ...
        conversation = Conversation(conversation_id="conv123", user_id="user123")
        conversation.add_message(MessageRole.USER, "Hello")
        conversation.add_message(MessageRole.ASSISTANT, "Hi!")
...
class TestMessageModel:
    ...
    def test_message_with_metadata(self):
        ...
        metadata = {"emotion": "happy", "confidence": 0.9}
        message = Message(
            role=MessageRole.ASSISTANT, content="I'm here to help!", metadata=metadata
        )
