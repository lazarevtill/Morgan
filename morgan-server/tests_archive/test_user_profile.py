...
class TestUserProfileCreation:
    ...
    def test_get_or_create_profile_returns_existing(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Create profile
            original = manager.create_profile("user123", preferred_name="Alice")
...
class TestUserProfileUpdates:
    ...
    def test_update_communication_style(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            updated = manager.update_profile(
                "user123", communication_style=CommunicationStyle.TECHNICAL
            )
    ...
    def test_update_response_length(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            updated = manager.update_profile(
                "user123", response_length=ResponseLength.BRIEF
            )
    ...
    def test_update_topics_of_interest(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            updated = manager.update_profile(
                "user123", topics_of_interest=["AI", "programming", "music"]
            )
    ...
    def test_update_metadata(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            updated = manager.update_profile(
                "user123", metadata={"favorite_color": "blue", "timezone": "UTC"}
            )
    ...
    def test_update_nonexistent_profile_raises_error(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with pytest.raises(ValueError, match="Profile not found"):
                manager.update_profile("nonexistent", preferred_name="Alice")
    ...
    def test_partial_update_preserves_other_fields(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert updated.preferred_name == "Alicia"
            assert updated.communication_style == CommunicationStyle.PROFESSIONAL
            assert "AI" in updated.topics_of_interest
...
class TestProfileMetrics:
    ...
    def test_update_metrics_invalid_engagement_score(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with pytest.raises(ValueError, match="Engagement score must be between"):
    ...
    def test_update_metrics_invalid_relationship_age(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with pytest.raises(
                ValueError, match="Relationship age days must be non-negative"
            ):
    ...
    def test_update_metrics_invalid_interaction_count(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with pytest.raises(
                ValueError, match="Interaction count must be non-negative"
            ):
...
class TestProfilePersistence:
    ...
    def test_metrics_update_persisted(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            manager1.update_metrics("user123", trust_level=0.75, interaction_count=50)
...
class TestProfileEdgeCases:
    ...
    def test_profile_with_none_values(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            profile = manager.create_profile("user123", preferred_name=None)
