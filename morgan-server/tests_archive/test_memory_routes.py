...
class TestMemorySearchEndpoint:
    ...
    def test_search_success(self, client, mock_memory_manager):
        ...
        response = client.get("/api/memory/search?query=test&user_id=user_123&limit=10")
        ...
        mock_memory_manager.search_conversations.assert_called_once_with(
            user_id="user_123", query="test", limit=10
        )
    ...
    def test_search_custom_limit(self, client, mock_memory_manager):
        ...
        response = client.get("/api/memory/search?query=test&user_id=user_123&limit=5")
    ...
    def test_search_limit_too_low(self, client):
        ...
        response = client.get("/api/memory/search?query=test&user_id=user_123&limit=0")
    ...
    def test_search_no_results(self, client, mock_memory_manager):
        ...
        response = client.get("/api/memory/search?query=nonexistent&user_id=user_123")
    ...
    def test_search_message_without_response(self, client, mock_memory_manager):
        ...
        response = client.get("/api/memory/search?query=test&user_id=user_123")
...
class TestMemoryCleanupEndpoint:
    ...
    def test_cleanup_success(self, client, mock_memory_manager):
        ...
        response = client.delete("/api/memory/cleanup?user_id=user_123&keep_recent=10")
        ...
        mock_memory_manager.cleanup_old_conversations.assert_called_once_with(
            user_id="user_123", keep_recent=10
        )
    ...
    def test_cleanup_custom_keep_recent(self, client, mock_memory_manager):
        ...
        response = client.delete("/api/memory/cleanup?user_id=user_123&keep_recent=5")

        assert response.status_code == 200

        # Verify keep_recent was passed correctly
        mock_memory_manager.cleanup_old_conversations.assert_called_once_with(
            user_id="user_123", keep_recent=5
        )
    ...
    def test_cleanup_keep_recent_too_high(self, client):
        ...
        response = client.delete("/api/memory/cleanup?user_id=user_123&keep_recent=200")
    ...
    def test_cleanup_keep_recent_too_low(self, client):
        ...
        response = client.delete("/api/memory/cleanup?user_id=user_123&keep_recent=0")
