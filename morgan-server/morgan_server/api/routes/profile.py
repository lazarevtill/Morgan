...
async def get_user_profile(
    ...
    try:
        ...
        return ProfileResponse(
            ...
            communication_style=(
                prefs.communication_style.value if prefs else "friendly"
            ),
            response_length=(
                prefs.preferred_response_length.value if prefs else "moderate"
            ),
...
async def get_user_timeline(
    ...
    try:
        ...
        return TimelineResponse(
            user_id=user_id, events=events, total_events=len(events)
        )
