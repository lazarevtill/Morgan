...
RESERVED_LOG_FIELDS = {
    ...
    'asctime', 'taskName', 'level', 'logger', 'timestamp'
}
...
def test_log_level_filtering_property(configured_level: str, message_level: str, message: str):
    """
    ...
    **Validates: Requirements 10.4**
    ...
    if message_level_num >= configured_level_num:
        ...
        try:
            ...
            assert log_entry["level"] == message_level, (
...
@given(
    min_level=log_level_strategy,
    test_level=log_level_strategy
)
@settings(max_examples=100, deadline=None)
...
def test_structured_logging_format_property(level: str, message: str, context: dict):
    ...
    **Validates: Requirements 10.5**
    ...
    assert logger_name in log_entry["logger"], (
    ...
    try:
        ...
        pytest.fail(f"Timestamp is not valid ISO 8601 format: {log_entry['timestamp']}\nError: {e}")
