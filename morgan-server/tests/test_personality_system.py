...
class TestConsistencyAcrossConversations:
    ...
    def test_consistency_check_small_difference(self):
        ...
        assert system.is_consistent_with_previous(user_id, current_traits, tolerance=0.2) is True
    ...
    def test_consistency_check_large_difference(self):
        ...
        assert system.is_consistent_with_previous(user_id, current_traits, tolerance=0.2) is False
    ...
    def test_consistency_check_custom_tolerance(self):
        ...
        assert system.is_consistent_with_previous(user_id, current_traits, tolerance=0.3) is True
        
        # Should be inconsistent with low tolerance
        assert system.is_consistent_with_previous(user_id, current_traits, tolerance=0.1) is False
...
class TestAdaptiveBehavior:
    ...
    def test_adaptive_behavior_new_relationship(self):
        ...
        result = system.apply_personality(
            "Hello",
    ...
    def test_adaptive_behavior_boundary_values(self):
        ...
        result_boundary = system.apply_personality(
            "Hello",
        ...
        result_above = system.apply_personality(
            "Hello",
            relationship_depth=0.51
        )
        assert "familiar_tone" in result_above.style_notes
        
        # Exactly at 0.8 threshold
        result_boundary2 = system.apply_personality(
            "Hello",
        ...
        result_above2 = system.apply_personality(
            "Hello",
            relationship_depth=0.81
        )
