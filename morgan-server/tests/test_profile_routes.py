...
def mock_assistant():
    ...
    def mock_update_profile(user_id: str, **updates):
        ...
        if 'communication_style' in updates:
            profile.communication_preferences.communication_style = updates['communication_style']
...
class TestGetUserTimeline:
    ...
    def test_get_timeline_with_milestones(self, client, mock_assistant):
        ...
        mock_assistant.get_user_profile = MagicMock(side_effect=mock_get_profile_with_milestones)
