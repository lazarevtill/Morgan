...
def test_multimodal_processor():
    ...
    try:
        ...
        print(
            f"   Combined Embeddings Dimension: {len(doc_no_images.combined_embedding)}"
        )
        ...
        try:
            ...
            print(
                f"   Text Embeddings Dimension: {len(doc_with_images.text_embeddings)}"
            )
            print(f"   Image Embeddings Count: {len(doc_with_images.image_embeddings)}")
            print(
                f"   Combined Embeddings Dimension: {len(doc_with_images.combined_embedding)}"
            )
