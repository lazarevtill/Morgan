...
class TestSystemIntegration:
    ...
    async def test_system_initialization(self, system_config):
        ...
        with patch.multiple(
            ...
            _validate_system_components=AsyncMock(return_value={'success': True, 'errors': []}),
    ...
    async def test_document_processing_workflow(self, integration_system):
        ...
        system.document_processor.process_documents.return_value = Mock(chunks=mock_chunks)
        ...
        system.embedding_service.create_hierarchical_embeddings.return_value = mock_embedding
    ...
    async def test_search_workflow_with_companion_features(self, integration_system):
        ...
        system.relationship_manager.get_user_context.return_value = mock_companion_context
        ...
        assert result.performance_metrics['strategies_used'] == ['semantic', 'contextual', 'emotional']
    ...
    async def test_conversation_workflow_end_to_end(self, integration_system):
        ...
        mock_memory_result = Mock(
            memories=[
                Mock(content="User interested in Docker deployment", importance_score=0.8),
                Mock(content="User prefers detailed explanations", importance_score=0.7)
            ]
        )
    ...
    async def test_system_health_monitoring(self, integration_system):
        ...
        system.knowledge_base.health_check = AsyncMock(return_value={'status': 'healthy'})
    ...
    async def test_performance_target_validation(self, integration_system):
        ...
        system.cache_manager.get_cache_statistics = AsyncMock(return_value={
            'average_speedup': 3.0  # Above target of 2.0
        })
        ...
        if 'candidate_reduction' in validation_results['target_results']:
            reduction_result = validation_results['target_results']['candidate_reduction']
    ...
    async def test_error_handling_and_recovery(self, integration_system):
        ...
        system.embedding_service.create_hierarchical_embeddings.side_effect = Exception("Embedding service failed")
    ...
    async def test_companion_personalization_integration(self, integration_system):
        ...
        conv_result = await system.conversation_workflow(
            user_message="I need help with ML model deployment",
            user_id=user_id
        )
    ...
    async def test_singleton_system_access(self, system_config):
        ...
        with patch('morgan.core.system_integration.AdvancedVectorizationSystem') as MockSystem:
            mock_instance = Mock()
...
class TestCompanionIntegration:
    ...
    async def test_emotional_intelligence_integration(self):
        ...
        with patch.multiple(
            ...
            result = await system.search_workflow(
                query="I'm stuck with this Docker problem",
    ...
    async def test_relationship_building_integration(self):
        ...
        with patch.multiple(
            ...
            system.assistant.ask.return_value = Mock(
                answer="Basic Docker help",
                confidence=0.7,
                sources=["docker_basics.md"]
            )
            
            result1 = await system.conversation_workflow(
                user_message="How do I use Docker?",
                user_id=user_id
            )
            ...
            assert system.relationship_manager.update_conversation_interaction.call_count == 2
