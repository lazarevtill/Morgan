...
from morgan.relationships import (
    RelationshipBuilder, MilestoneDetector, RelationshipTimeline,
    RelationshipDynamics, RelationshipAdaptation
)
from morgan.emotional.models import (
    CompanionProfile, EmotionalState, EmotionType, ConversationContext,
    InteractionData, UserPreferences, CommunicationStyle, ResponseLength
)
...
class TestRelationshipModules:
    ...
    def test_relationship_builder_assess_stage(self):
        ...
        assert stage.value in ['initial', 'building', 'established', 'deep', 'companion']
    ...
    def test_milestone_detector_detect_milestones(self):
        ...
        milestones = detector.detect_milestones(
            self.profile, self.interaction_data
        )
