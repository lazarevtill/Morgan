...
class TestHierarchicalEmbeddingService:
    ...
    def test_create_hierarchical_embeddings(self):
        ...
        result = self.service.create_hierarchical_embeddings(content, metadata, category="code")
    ...
    def test_category_detection(self):
        ...
        assert self.service._detect_category(doc_content, doc_metadata) == "documentation"
        
        # Test API detection
        api_content = "This endpoint handles authentication requests and returns tokens."
    ...
    def test_batch_processing(self):
        ...
        batch_embeddings = [
            [0.1, 0.1], [0.2, 0.2], [0.3, 0.3],  # Item 1: coarse, medium, fine
            [0.4, 0.4], [0.5, 0.5], [0.6, 0.6],  # Item 2: coarse, medium, fine
            [0.7, 0.7], [0.8, 0.8], [0.9, 0.9]   # Item 3: coarse, medium, fine
        ]
