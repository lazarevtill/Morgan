...
class TestEmpatheticResponseGenerator:
    ...
    def test_generate_empathetic_response_joy(
        self, generator, emotional_state_joy, conversation_context
    ):
    ...
    def test_generate_empathetic_response_sadness(
        self, generator, emotional_state_sadness, conversation_context
    ):
        ...
        assert (
            "gentle" in response.emotional_tone
            or "supportive" in response.emotional_tone
        )
    ...
    def test_generate_supportive_response_emotional(
        self, generator, emotional_state_sadness, conversation_context
    ):
    ...
    def test_generate_supportive_response_practical(
        self, generator, emotional_state_sadness, conversation_context
    ):
    ...
    def test_create_relationship_aware_response(
        self, generator, emotional_state_joy, conversation_context, companion_profile
    ):
    ...
    def test_empathy_level_calculation_high_intensity(
        self, generator, conversation_context
    ):
    ...
    def test_empathy_level_calculation_low_intensity(
        self, generator, conversation_context
    ):
        ...
        empathy_level = generator._calculate_empathy_level(
            low_intensity_state, conversation_context
        )
    ...
    def test_personalization_elements_high_intensity(
        self, generator, conversation_context, companion_profile
    ):
    ...
    def test_build_relationship_context_established(
        self, generator, conversation_context, companion_profile
    ):
        """Test building relationship context for established relationship."""
        context_str = generator._build_relationship_context(
            conversation_context, companion_profile
        )

        assert context_str is not None
        assert (
            "established_relationship" in context_str
            or "developing_relationship" in context_str
        )
    ...
    def test_build_relationship_context_new(self, generator, conversation_context):
        ...
        context_str = generator._build_relationship_context(
            conversation_context, new_profile
        )

        assert "new_relationship" in context_str

    def test_response_confidence_calculation(
        self, generator, emotional_state_joy, conversation_context, companion_profile
    ):
