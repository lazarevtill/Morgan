...
from morgan.memory.memory_processor import (
    MemoryProcessor, Memory, MemoryExtractionResult, get_memory_processor
)
...
class TestMemoryProcessor:
    ...
    def mock_dependencies(self):
        ...
        with patch('morgan.memory.memory_processor.get_settings') as mock_settings, \
             patch('morgan.memory.memory_processor.get_embedding_service') as mock_embedding, \
             patch('morgan.memory.memory_processor.VectorDBClient') as mock_vector_db, \
             patch('morgan.memory.memory_processor.get_emotional_intelligence_engine') as mock_emotional:
    ...
    def test_extract_memories_basic(self, memory_processor, sample_conversation_turn, sample_emotional_state):
    ...
    def test_extract_personal_preferences(self, memory_processor):
        ...
        preferences = memory_processor.extract_personal_preferences(conversation_history)
        ...
        assert preferences.communication_style in [style.value for style in CommunicationStyle]
        assert preferences.preferred_response_length in [length.value for length in ResponseLength]
    ...
    def test_emotional_weight_calculation(self, memory_processor):
        ...
        weight_low_neutral = memory_processor._calculate_emotional_weight(low_neutral, False)
    ...
    def test_relationship_significance_calculation(self, memory_processor):
        ...
        relationship_text = "I really trust you and feel comfortable sharing this personal information"
    ...
    def test_extract_emotional_insights(self, memory_processor, sample_conversation_turn, sample_emotional_state):
    ...
    def test_extract_preference_updates(self, memory_processor, sample_conversation_turn, sample_emotional_state):
    ...
    def test_extract_relationship_indicators(self, memory_processor, sample_emotional_state):
    ...
    def test_response_length_preference_determination(self, memory_processor):
        ...
        preference = memory_processor._determine_response_length_preference(brief_history)
        ...
        preference = memory_processor._determine_response_length_preference(detailed_history)
    ...
    def test_memory_extraction_with_no_emotional_context(self, memory_processor, sample_conversation_turn, mock_dependencies):
