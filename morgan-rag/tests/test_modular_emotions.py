...
class TestEmotionalStateTracker:
    ...
    def test_emotion_statistics(self, tracker):
        ...
        # Track some emotions
        emotions = [
            EmotionalState(primary_emotion=EmotionType.JOY, intensity=0.8, confidence=0.9),
            EmotionalState(primary_emotion=EmotionType.JOY, intensity=0.7, confidence=0.8),
            EmotionalState(primary_emotion=EmotionType.SADNESS, intensity=0.6, confidence=0.7)
        ]
...
class TestEmotionClassifier:
    ...
    def test_classify_emotion(self, classifier):
        ...
        assert classification["intensity_classification"]["intensity_category"] in ["high", "extreme"]
...
class TestIntensityMeasurer:
    ...
    def test_batch_intensity_measurement(self, measurer):
        ...
        emotions = [
            EmotionalState(primary_emotion=EmotionType.JOY, intensity=0.8, confidence=0.9),
            EmotionalState(primary_emotion=EmotionType.SADNESS, intensity=0.6, confidence=0.8)
        ]
...
class TestModularIntegration:
    ...
    def components(self):
        ...
        with patch('morgan.emotions.detector.get_llm_service'), \
             patch('morgan.emotions.tracker.get_settings') as mock_settings:
