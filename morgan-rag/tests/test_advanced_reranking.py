...
def test_reranking_with_metrics():
    ...
    service = JinaRerankingService(enable_background=False, enable_resource_monitoring=False)
...
def test_background_processing():
    ...
    # Disable resource monitoring for testing
    service = JinaRerankingService(enable_background=True, enable_resource_monitoring=False)
