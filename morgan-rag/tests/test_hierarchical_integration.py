...
'''
    ...
    def test_batch_processing_mixed_content(self):
        ...
        batch_embeddings = [
            [0.1, 0.1], [0.2, 0.2], [0.3, 0.3],  # Item 1
            [0.4, 0.4], [0.5, 0.5], [0.6, 0.6],  # Item 2
            [0.7, 0.7], [0.8, 0.8], [0.9, 0.9]   # Item 3
        ]
        ...
        assert results[2].metadata["category"] == "troubleshooting"  # Should detect error content
