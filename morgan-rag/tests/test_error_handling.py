...
from morgan.utils.error_handling import (
    ...
    RetryConfig, with_retry, RetryExhaustedError,
    CircuitBreaker, CircuitState, CircuitBreakerError, CircuitBreakerConfig,
    GracefulDegradationManager, DegradationLevel, DegradationConfig,
    ErrorRecoveryManager, RecoveryStrategy, RecoveryProcedure,
    error_context, get_degradation_manager, get_recovery_manager,
    SystemHealthMonitor, HealthStatus, HealthCheck,
    initialize_error_handling
)

from morgan.utils.error_decorators import (
    handle_vectorization_errors, handle_embedding_errors, handle_storage_errors,
    handle_search_errors, handle_companion_errors, handle_emotional_processing_errors,
    handle_memory_processing_errors, handle_cache_errors, handle_validation_errors,
    monitor_performance, robust_vectorization_operation, robust_companion_operation
)
...
class TestSystemHealthMonitor:
    ...
    def test_health_check_registration(self):
        ...
        assert health_status["components"]["service1"]["status"] == HealthStatus.HEALTHY.value
        assert health_status["components"]["service2"]["status"] == HealthStatus.UNHEALTHY.value
