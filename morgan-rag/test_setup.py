...
def test_llm_direct():
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[{"role": "user", "content": "Say 'Hello, Morgan is working!' in one sentence."}],
            max_tokens=50,
            timeout=30.0
        )
...
def test_embedding_service():
    ...
    try:
        ...
        print(f"Embedding Base URL: {settings.embedding_base_url or 'Not set (will use OLLAMA_HOST)'}")
