...
class EmotionalMemory:
    ...
    def calculate_current_importance(self) -> float:
        ...
        decay_rate = 0.02 * (1.0 - emotional_weight * 0.5)  # Slower decay for intense emotions
        ...
        total_decay = max(0.1, 1.0 - (days_old * decay_rate) + relationship_bonus + access_bonus)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'emotional_state': {
                ...
                'secondary_emotions': [e.value for e in self.emotional_state.secondary_emotions],
