...
class EmotionClassifier:
    ...
    CONTEXTUAL_MODIFIERS = {
        ...
        "relationships": {
            "stress_indicators": ["partner", "family", "friend", "relationship", "love"],
    ...
    def classify_emotion(
        ...
        classification = {
            ...
            "contextual_factors": self._analyze_contextual_factors(emotional_state, context),
            "confidence_assessment": self._assess_classification_confidence(emotional_state)
        }
        
        # Add overall classification summary
        classification["summary"] = self._generate_classification_summary(classification)
    ...
    def find_similar_emotions(
        ...
        for emotion in EmotionType:
            ...
            similarity = self._calculate_dimensional_similarity(target_dims, emotion_dims)
    ...
    def analyze_emotion_transitions(
        self,
        emotion_sequence: List[EmotionalState]
    ) -> Dict[str, Any]:
        """
        ...
        for i in range(len(emotion_sequence) - 1):
            ...
            transition = {
                ...
                "time_gap": (emotion_sequence[i + 1].timestamp - emotion_sequence[i].timestamp).total_seconds(),
                "intensity_change": emotion_sequence[i + 1].intensity - emotion_sequence[i].intensity
            }
    ...
    def _classify_primary_emotion(self, emotional_state: EmotionalState) -> Dict[str, Any]:
        ...
        if emotional_state.secondary_emotions:
            purity_score = max(0.3, 1.0 - (len(emotional_state.secondary_emotions) * 0.2))
    ...
    def _analyze_dimensions(self, emotional_state: EmotionalState) -> Dict[str, Any]:
        ...
        return {
            ...
            "dominant_dimension": max(
                dimensions.keys(),
                key=lambda d: abs(dimensions[d]["value"])
            )
        }
    
    def _detect_complex_emotions(self, emotional_state: EmotionalState) -> Dict[str, Any]:
        ...
        detected_patterns = []
        emotions_set = {emotional_state.primary_emotion} | set(emotional_state.secondary_emotions)
        ...
        return {
            ...
            "complexity_score": len(emotional_state.secondary_emotions) / 3.0  # Normalize to 0-1
        }
    ...
    def _analyze_contextual_factors(
        ...
        for context_type, config in self.CONTEXTUAL_MODIFIERS.items():
            ...
            indicator_matches = [
                indicator for indicator in stress_indicators
    ...
    def _assess_classification_confidence(self, emotional_state: EmotionalState) -> Dict[str, Any]:
        ...
        confidence_factors = {
            ...
            "intensity_clarity": 1.0 - abs(emotional_state.intensity - 0.5) * 2,  # Higher for extreme values
            "indicator_quality": len(emotional_state.emotional_indicators) / 5.0,  # More indicators = higher confidence
            "complexity_penalty": max(0.0, 1.0 - len(emotional_state.secondary_emotions) * 0.2)
        }
        ...
        return {
            ...
            "reliability": "high" if overall_confidence > 0.7 else "medium" if overall_confidence > 0.4 else "low"
        }
    
    def _generate_classification_summary(self, classification: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "complexity": "high" if complex_emotions.get("complexity_score", 0.0) > 0.6 else "low",
    ...
    def _get_emotion_family(self, emotion: EmotionType) -> str:
        ...
        families = {
            ...
            "negative": [EmotionType.SADNESS, EmotionType.ANGER, EmotionType.FEAR, EmotionType.DISGUST],
