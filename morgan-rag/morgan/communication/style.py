...
class CommunicationStyleAdapter:
    ...
    def adapt_communication_style(
        ...
        adapted_tone = self._adapt_tone_for_emotion(emotional_state, base_style)
    ...
    def learn_from_feedback(
        ...
        logger.debug(
            f"Learned from feedback for user {user_id}: " f"score={feedback_score:.2f}"
        )
    ...
    def _adapt_tone_for_emotion(
        self, emotional_state: EmotionalState, base_style: CommunicationStyle
    ) -> CommunicationTone:
        ...
        emotion_tone = emotion_tone_map.get(
            emotional_state.primary_emotion.value, CommunicationTone.FRIENDLY
        )
    ...
    def _determine_complexity_level(
        ...
        if companion_profile and companion_profile.communication_preferences:
            pref_length = (
                companion_profile.communication_preferences.preferred_response_length
            )
        ...
        if any(
            indicator in context.message_text.lower()
    ...
    def _store_adaptation_result(
        self, user_id: str, result: StyleAdaptationResult
    ) -> None:
    ...
    def _analyze_feedback_for_preferences(
        self, user_id: str, feedback_text: str, adaptation_result: StyleAdaptationResult
    ) -> None:
    ...
    def _get_successful_adaptations(self, user_id: str) -> List[StyleAdaptationResult]:
    ...
    def _analyze_context_requirements(
        ...
        requirements = {
            ...
            "technical_content_present": self._has_technical_content(
    ...
    def _recommend_tone(
        ...
        return self._adapt_tone_for_emotion(
            emotional_state, CommunicationStyle.FRIENDLY
        )
    ...
    def _get_emotional_considerations(
        ...
        considerations.append(
            f"primary_emotion:{emotional_state.primary_emotion.value}"
        )
