...
class ProfileStorage:
                ...
                with open(self.profiles_file, "r", encoding="utf-8") as f:
                    ...
                    for user_id, profile_data in profiles_data.items():
                        ...
                        if "communication_preferences" in profile_data:
                            profile_data["communication_preferences"] = UserPreferences(
                        ...
                        for milestone_data in profile_data.get(
                            ...
                            milestone_data["timestamp"] = datetime.fromisoformat(
                                milestone_data["timestamp"]
                            )
                            milestones.append(RelationshipMilestone(**milestone_data))
            ...
            if self.preferences_file.exists():
                with open(self.preferences_file, "r", encoding="utf-8") as f:
                    ...
                    for user_id, pref_data in preferences_data.items():
                        self._preferences_cache[user_id] = UserPreferences(**pref_data)

            logger.info(
                "Loaded %d companion profiles and %d preference sets",
                len(self._profile_cache),
                len(self._preferences_cache),
            )
    ...
    def store_companion_profile(self, profile: CompanionProfile) -> bool:
        ...
        try:
            ...
            logger.debug("Stored companion profile for user: %s", profile.user_id)
            return True

        except Exception as e:
            logger.error(
                "Error storing companion profile for user %s: %s", profile.user_id, e
            )
            return False
    ...
    def update_interaction_stats(self, user_id: str) -> bool:
        ...
        try:
            ...
            if profile:
                ...
                profile.relationship_duration = current_time - profile.created_at
            ...
            logger.error("Error updating interaction stats for user %s: %s", user_id, e)
            return False
    ...
    def get_profile_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self._profile_cache:
                ...
                stats["avg_relationship_duration_days"] = avg_duration / (24 * 3600)
