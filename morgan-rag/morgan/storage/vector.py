...
class VectorStorage:
    ...
    def store_documents(
        ...
        try:
            ...
            if success:
                logger.info(
                    "Stored %d documents in %s", len(documents), collection_name
                )
            else:
    ...
    def search_vectors(
        ...
        try:
            ...
            logger.debug("Found %d results in %s", len(search_results), collection_name)
    ...
    def delete_document(self, collection_name: str, document_id: str) -> bool:
        ...
        try:
            ...
            if success:
                logger.info("Deleted document %s from %s", document_id, collection_name)
            else:
