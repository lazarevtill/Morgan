...
class CacheStorage:
    ...
    def _initialize_cache_systems(self) -> None:
        ...
        try:
            ...
            self.git_tracker = GitHashTracker(self.config.get("git_tracker", {}))
    ...
    def check_cache_validity(
        ...
        try:
            if self.intelligent_cache:
                ...
                return {"is_valid": False, "reason": "Cache system not available"}
    ...
    def store_cache_metadata(
        self, source_path: str, collection_name: str, metadata: Dict[str, Any]
    ) -> bool:
        """
    ...
    def cleanup_expired_cache(self, max_age_hours: int = 24) -> int:
        ...
        try:
            ...
            if self.intelligent_cache and hasattr(
                self.intelligent_cache, "cleanup_expired"
            ):
                cleaned_count += self.intelligent_cache.cleanup_expired(max_age_hours)
            else:
                # Fallback cleanup
