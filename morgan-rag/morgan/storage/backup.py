...
class BackupStorage:
    ...
    def create_backup(self, backup_name: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if not backup_name:
                backup_name = (
                    f"morgan_backup_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
                )
            ...
            return {"name": backup_name or "unknown", "success": False, "error": str(e)}
    ...
    def restore_backup(self, backup_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"name": backup_name, "success": False, "error": str(e)}
    ...
    def _restore_memory_storage(self, backup_path: Path) -> None:
        ...
        memory_files = ["memories.jsonl", "emotions.jsonl", "profiles.json"]
