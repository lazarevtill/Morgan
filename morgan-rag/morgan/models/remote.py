...
class RemoteModelManager:
    ...
    def _lazarev_embedding(self, client: Dict[str, Any], text: str) -> List[float]:
        ...
        try:
            ...
            payload = {"model": client["model_name"], "input": text}
    ...
    def generate_response(
        self, client: Dict[str, Any], prompt: str, context: str = ""
    ) -> str:
    ...
    def _lazarev_response(
        ...
        try:
            ...
            payload = {"model": client["model_name"], "messages": messages}
