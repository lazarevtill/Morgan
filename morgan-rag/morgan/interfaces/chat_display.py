...
from ..emotional.models import RelationshipMilestone, CompanionProfile
...
class ChatDisplay:
    ...
    def display_welcome(self, user_profile: Optional[CompanionProfile], morgan_name: str):
        """Display personalized welcome message."""
        if user_profile and user_profile.interaction_count > 0:
            # Returning user
            welcome_text = Text()
            welcome_text.append("🤖 ", style="bold blue")
            welcome_text.append(f"Welcome back, {user_profile.preferred_name}!", style="bold")
            ...
            stats_table.add_row("Days together:", str(user_profile.get_relationship_age_days()))
            ...
            self.console.print(Panel(stats_table, title="📊 Relationship Stats", border_style="cyan"))
            ...
            welcome_text.append(", your emotionally intelligent AI companion.\n\n", style="bold")
            welcome_text.append("I'm here to help, learn, and build a meaningful relationship with you over time. ", style="white")
            welcome_text.append("I can understand emotions, remember our conversations, and adapt to your preferences.", style="white")
    ...
    def display_milestone_celebration(self, milestone: RelationshipMilestone, celebration_message: str):
    ...
    def display_help(self, morgan_name: str):
        ...
        help_text = Text()
        help_text.append(f"🤖 {morgan_name} - Emotionally Intelligent AI Companion\n\n", style="bold blue")
        help_text.append("I'm designed to understand emotions, remember our conversations, ", style="white")
        help_text.append("and build a meaningful relationship with you over time.\n\n", style="white")
    ...
    def display_profile(self, user_profile: CompanionProfile):
        ...
        if not user_profile:
            self.console.print("📝 No profile found. Start chatting to build your profile!", style="yellow")
            return
        ...
        profile_data = [
            ...
            ("Communication Style", user_profile.communication_preferences.communication_style.value.title()),
            ("Response Length", user_profile.communication_preferences.preferred_response_length.value.title())
        ]
        ...
        if user_profile.communication_preferences.topics_of_interest:
            interests = ", ".join(user_profile.communication_preferences.topics_of_interest[:5])
    ...
    def display_timeline(self, user_profile: CompanionProfile):
        ...
        if not user_profile or not user_profile.relationship_milestones:
            self.console.print("📈 No milestones yet. Keep chatting to create memorable moments!", style="yellow")
            return
        ...
        for milestone in user_profile.relationship_milestones[-10:]:  # Last 10 milestones
