...
class EmotionalValidator:
    ...
    def validate_emotional_experience(
        self, emotional_state: EmotionalState, user_description: str
    ) -> Dict[str, Any]:
        """
    ...
    def create_affirmation_response(
        self, emotional_state: EmotionalState, specific_concern: Optional[str] = None
    ) -> str:
        """
        ...
        base_affirmations = affirmations.get(
        ...
        if emotional_state.intensity > 0.7:
            ...
            selected_affirmation = (
                base_affirmations[0]
                if base_affirmations
                else "You are strong and capable."
            )
        else:
            ...
            selected_affirmation = (
                base_affirmations[-1]
                if base_affirmations
                else "Your feelings are valid."
            )

        # Add specific concern addressing if provided
        if specific_concern:
            concern_response = self._address_specific_concern(
                specific_concern, emotional_state
            )
            if concern_response:
    ...
    def _address_specific_concern(
        self, concern: str, emotional_state: EmotionalState
    ) -> Optional[str]:
