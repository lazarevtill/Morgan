...
class EmotionalToneManager:
    ...
    EMOTION_TONE_MAP = {
        ...
        EmotionType.SADNESS: {
            ...
            "secondary": [ToneType.COMPASSIONATE_CARING, ToneType.UNDERSTANDING_VALIDATING],
            "intensity_modifiers": {
                "high": ToneIntensity.STRONG,
                "medium": ToneIntensity.MODERATE,
                "low": ToneIntensity.SUBTLE
        ...
        EmotionType.ANGER: {
            ...
            "secondary": [ToneType.UNDERSTANDING_VALIDATING, ToneType.RESPECTFUL_NEUTRAL],
            "intensity_modifiers": {
        ...
        EmotionType.DISGUST: {
            ...
            "secondary": [ToneType.UNDERSTANDING_VALIDATING, ToneType.COMPASSIONATE_CARING],
            "intensity_modifiers": {
                "high": ToneIntensity.MODERATE,
                "medium": ToneIntensity.MODERATE,
                "low": ToneIntensity.SUBTLE
    ...
    TONE_CHARACTERISTICS = {
        ...
        ToneType.ENERGETIC_ENTHUSIASTIC: {
            "adjectives": ["exciting", "wonderful", "amazing", "fantastic", "brilliant"],
            "phrases": [
                "That's fantastic!",
                "How exciting!",
        ...
        ToneType.UNDERSTANDING_VALIDATING: {
            "adjectives": ["valid", "understandable", "reasonable", "natural", "normal"],
            "phrases": [
        ...
        ToneType.ENCOURAGING_UPLIFTING: {
            "adjectives": ["hopeful", "positive", "inspiring", "uplifting", "motivating"],
            "phrases": [
                "You've got this",
                "I believe in you",
        ...
        ToneType.RESPECTFUL_NEUTRAL: {
            "adjectives": ["respectful", "balanced", "thoughtful", "considerate", "measured"],
            "phrases": [
    ...
    def match_emotional_tone(
        ...
        emotion_tone_config = self.EMOTION_TONE_MAP.get(
            ...
            self.EMOTION_TONE_MAP[EmotionType.NEUTRAL]
        )
        ...
        tone_config = {
            ...
            "adaptation_confidence": self._calculate_adaptation_confidence(emotional_state, context),
    ...
    def analyze_user_tone_preferences(
        ...
        return {
            ...
            "emotional_expressiveness": message_analysis.get("expressiveness", "moderate"),
            "response_length_preference": message_analysis.get("length_preference", "medium"),
    ...
    def _get_combined_tone_characteristics(
        ...
        combined = {
            "adjectives": primary_chars.get("adjectives", []) + secondary_chars.get("adjectives", [])[:2],
            "phrases": primary_chars.get("phrases", []) + secondary_chars.get("phrases", [])[:2],
            "sentence_starters": primary_chars.get("sentence_starters", []) + secondary_chars.get("sentence_starters", [])[:2],
    ...
    def _adapt_tone_rule_based(
        ...
        if sentence_starters and not any(adapted_text.startswith(starter.split()[0]) for starter in sentence_starters):
    ...
    def _analyze_message_characteristics(
        ...
        for msg in conversation_history:
            text_lower = msg.message_text.lower()
            expressiveness_score += sum(1 for indicator in expressive_indicators if indicator in text_lower)
    ...
    def _determine_preferred_tones(
        ...
        if feedback_analysis.get("feedback_available") and feedback_analysis.get("avg_rating", 3) >= 4:
        ...
        if not preferred_tones:
            preferred_tones = [ToneType.WARM_SUPPORTIVE, ToneType.UNDERSTANDING_VALIDATING]
    ...
    def _calculate_preference_confidence(
        ...
        conversation_factor = min(1.0, conversation_count / 10.0)  # Full confidence at 10+ conversations
        feedback_factor = min(1.0, feedback_count / 5.0)  # Full confidence at 5+ feedback items
