...
class ResourceMonitor:
    ...
    def check_resources(self) -> ResourceStatus:
        ...
        try:
            ...
            cpu_limit = self.active_hours_cpu_limit if active_hours else self.quiet_hours_cpu_limit
            can_run_task = (cpu_usage < cpu_limit) and (memory_usage < self.memory_limit)
