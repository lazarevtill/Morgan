...
from morgan.core.domain.interfaces import EmbeddingProvider, RerankerProvider, ScraperProvider
...
class JinaEmbeddingAdapter(EmbeddingProvider):
    ...
    def __init__(self, jina_service: JinaEmbeddingService, model_name: str = "jina-embeddings-v4"):
