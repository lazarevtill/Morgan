...
class KnowledgeRepository:
    ...
    def search(self, query_vector: List[float], limit: int, score_threshold: float) -> List[KnowledgeChunk]:
        ...
        for res in search_results:
            ...
            chunks.append(KnowledgeChunk(
                ...
                ingested_at=datetime.fromisoformat(payload.get("ingested_at")) if payload.get("ingested_at") else datetime.utcnow(),
...
class MemoryRepository:
    ...
    """
    def __init__(self, vector_db: VectorDBClient, turn_collection: str, conv_collection: str):
        self.vector_db = vector_db
    ...
    def get_recent_turns(self, conversation_id: str, limit: int) -> List[ConversationTurn]:
        ...
        for res in results:
            ...
            turns.append(ConversationTurn(
                turn_id=str(res.id) if hasattr(res, 'id') else payload.get('turn_id'),
