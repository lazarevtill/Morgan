...
class ReasoningEngine:
    ...
    async def contextualize_query(self, question: str, history: List[Dict[str, str]]) -> str:
        """
...
Standalone Question:"""
    ...
    def build_system_prompt(self, emotional_state: Any, style: Any, profile: Any) -> str:
        """
        ...
        if profile:
            prompt += f"You are talking to {profile.get('preferred_name', 'the user')}.\n"
