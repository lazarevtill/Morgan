...
class WebSocketHandler:
        ...
        try:
            while True:
                ...
                if message_type == "start":
                    ...
                    if not session_id:
                        await self._send_error(websocket, "No active session. Send 'start' first.")
                        continue
    ...
    async def _handle_start(
        ...
        try:
            ...
            # Send confirmation
            await self._send_message(websocket, "session_started", {
    ...
    async def _handle_audio_chunk(
        ...
        try:
            ...
            if result["status"] == "success":
                await self._send_message(websocket, "transcription", {
                    "text": result["text"],
                ...
                await self._send_message(websocket, "vad_status", {
                    "speech_detected": False,
                    "vad_result": result["vad_result"]
                })
            elif result["status"] == "error":
                await self._send_error(websocket, result.get("message", "Processing error"))
    ...
    async def _handle_text_message(
        ...
        try:
            ...
            async for chunk in self.streaming_orchestrator.process_complete_utterance(
                ...
                if chunk["type"] == "text":
                    # LLM text chunk
                    await self._send_message(websocket, "response_text", {
                        "text": chunk["text"],
                    ...
                    await self._send_message(websocket, "response_audio", {
                    ...
                    # Processing complete
                    await self._send_message(websocket, "response_complete", {
                        "text": chunk["text"],
                        "is_final": True
                    })
    ...
    async def _handle_utterance_end(
        ...
        try:
            ...
            await self._handle_text_message(websocket, session_id, {"text": transcription})
    ...
    async def _handle_stop(
        ...
        try:
            ...
            # Send confirmation
            await self._send_message(websocket, "session_ended", {
                "session_id": session_id,
                "status": "ended",
    ...
    async def _handle_config(
        ...
        try:
            ...
            # Send confirmation
            await self._send_message(websocket, "config_updated", {
                "session_id": session_id,
                "config": data
            })
