...
console.print("This CLI (cli.py) is deprecated and will be removed in a future release.\n")
...
console.print("For migration instructions, see [yellow]MIGRATION.md[/yellow] in the root directory.\n")
