...
(``scan``) and the report-only pass over the transcripts (``report``, Task 21). CPU only: no
model, no embedding, no network. Nothing this package produces carries a matched value."""
