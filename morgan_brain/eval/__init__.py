...
Retrieval quality has been the project's largest unmeasured claim: the suite that looked like
a quality harness ran over a hash embedder and proved only that the plumbing was connected.
