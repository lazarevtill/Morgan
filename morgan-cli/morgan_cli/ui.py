...
def render_paginated(
    ...
    while current_page < total_pages:
        ...
        console.clear()
        page_title = f"{title} (Page {current_page + 1}/{total_pages})" if title else f"Page {current_page + 1}/{total_pages}"
...
def render_server_error(status_code: int, message: str, details: Optional[Dict[str, Any]] = None) -> None:
    """
